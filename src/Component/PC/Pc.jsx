...
let res=await axios.get("https://free-to-play-games-database.p.rapidapi.com/api/games", {
     params: { platform: 'pc' , 'sort-by':`${type}`},
...
<div className="d-flex align-items-center pointer">
  ...
  <p className='m-0 me-1 genre' onClick={()=>getgame("release-date")}>Release Date</p>
  <p className='m-0 me-1 genre' onClick={()=>getgame("popularity")}>Popularity</p>
  <p className='m-0 me-1 genre' onClick={()=>getgame("alphabetical")}>Alphabetical</p>
  <p className='m-0 me-1 genre' onClick={()=>getgame("relevance")}>Relevance</p>
</div>
